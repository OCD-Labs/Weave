...
interface IWeaveRegistry {
    struct AssetConfig {
        ...
        address oracle;       // IWeaveOracle implementor — mock on testnet, real feed on mainnet
        string  symbol;
        string  name;
        string  sector;
        bool    active;
    ...
    /// @notice Reads the oracle for token and validates staleness.
    ...
    function registerBasket(address basket, address creatorToken, address creator) external;
